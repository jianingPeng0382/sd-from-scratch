...
img = Image.open("/opt/data/private/pjn/sd-from-scratch/images/cat.jpg")
...
# Convert back to image and save as jpg
noise_img = Image.fromarray(noise_imgs[7].squeeze(0).numpy(), 'RGB')
noise_img.save("/opt/data/private/pjn/sd-from-scratch/images/noise_img.jpg")
